...
public class Introduccion extends JDialog implements ActionListener{
	...
	private IntroduccionFondo fondoIntroduccion;
	public Introduccion(Ventana_principal v){
		ventana=v;
		confi_ini();
		crear_contenido();
		confi_fin();
	...
	private void crear_contenido() {
		fondoIntroduccion=new IntroduccionFondo();
